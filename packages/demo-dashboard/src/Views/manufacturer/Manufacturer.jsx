        ...
        <div className={cn(align.full, align.topCenter, align.noMarginPad)}>
               <Loading loading={loading} />
                                        ...
                                        ins.map( (f, i) => {
                                            return (
                                                <Row key={i} className={cn(align.full, align.noMarginPad, align.topCenter)}>
                                                    ...
                                                    <Col xs="12" className={cn(align.allCenter, align.noMarginPad)}>
                                                        <Input className={cn(align.full)} 
                                                                onChange={e=>tryCall(paramChanged, i, e.target.value)}
                                                                value={vals[i] || ''} />
                                                    </Col>
                                                </Row>
                                            )
                ...
                <Row className={cn(align.full, "py-4", align.noMarginPad, align.allCenter)}>
                    <Col xs="6" className={cn(align.allCenter, align.noMarginPad)}>
                        <Button size="sm" color={dirty?"primary":"secondary"}
                            disabled={!dirty} 
                             onClick={generateCode}>Generate QR Code</Button>
                    </Col>
                </Row>
